 ...
 */
public class InfiniteListAdapter extends InfiniteScrollListAdapter {
	
	// A placeholder for all the data points
	private final List<String> entries = new ArrayList<String>();
	private final NewPageListener newPageListener;
	...
	public InfiniteListAdapter(NewPageListener newPageListener) {
